...
--langs de,es,it,nl,pl,pt,ro,sl,tr,en,ru \
--lang-pairs de-en,es-en,it-en,nl-en,pl-en,pt-en,ro-en,sl-en,tr-en,ru-en \
...
--save-dir ../checkpoints/iwslt_base/latin+ru-to-one/ --max-source-positions 256 --max-target-positions 256 \
--skip-invalid-size-inputs-valid-test --tensorboard-logdir ../checkpoints/iwslt_base/latin+ru-to-one/log/
