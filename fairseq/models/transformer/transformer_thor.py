...
from fairseq.modules.transformer_thor_layer import ThorTransformerDecoderLayer, ThorTransformerEncoderLayer
...
class ThorTransformerModel(TransformerModel):
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument('--num-experts', type=int, default=1, metavar='D')
