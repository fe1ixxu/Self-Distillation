...
@register_model("transformer_IN")
class TransformerModelIN(TransformerModelBaseIN):
    """
    This is the legacy implementation of the transformer model that
    uses argparse for configuration.
    """
...
@register_model_architecture("transformer_IN", "transformer_IN")
def base_architecture_IN(args):
    args.encoder_embed_path = getattr(args, "encoder_embed_path", None)
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 2048)
    args.encoder_layers = getattr(args, "encoder_layers", 6)
...
@register_model_architecture("transformer_IN", "transformer_iwslt_de_en_IN")
def transformer_iwslt_de_en_IN(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 1024)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 4)
    args.encoder_layers = getattr(args, "encoder_layers", 6)
...
@register_model_architecture("transformer_IN", "transformer_iwslt_de_en_IN2")
def transformer_iwslt_de_en_IN2(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
...
@register_model_architecture("transformer_IN", "transformer_vaswani_wmt_en_de_big_IN")
def transformer_vaswani_wmt_en_de_big_IN(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 1024)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 4096)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 16)
    args.encoder_normalize_before = getattr(args, "encoder_normalize_before", False)
